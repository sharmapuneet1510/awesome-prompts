...
python tools/exporter.py --target copilot Codex --skills java,spring --agents developer
...
**Supported platforms:** copilot, Codex, cursor, windsurf, gemini, continue, openai, aider
