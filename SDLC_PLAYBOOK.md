...
- For *worked examples* of individual stages, see [SDLC_EXAMPLES_INDEX.md](SDLC_EXAMPLES_INDEX.md).
- For *per-function* inputs and outputs, see [AGENTS_FUNCTIONS.md](AGENTS_FUNCTIONS.md).
- For the *rules* the gates enforce, see [instructions/master_instruction_set.md](instructions/master_instruction_set.md).
...
- **[SDLC_EXAMPLES_INDEX.md](SDLC_EXAMPLES_INDEX.md)** — worked examples per agent
- **[AGENTS_FUNCTIONS.md](AGENTS_FUNCTIONS.md)** — per-function inputs and outputs
- **[FUNCTION_QUICK_REFERENCE.md](FUNCTION_QUICK_REFERENCE.md)** — one-page cheat sheets
- **[SPECIALIST_AGENT_MODES.md](SPECIALIST_AGENT_MODES.md)** — nine specialist role modes
- **[agents/README.md](agents/README.md)** — agent descriptions and dispatch syntax
- **[skills/README.md](skills/README.md)** — the 35 reusable skills
- **[instructions/master_instruction_set.md](instructions/master_instruction_set.md)** — RULES 0–12
