...
You are an expert software engineer assisting with this codebase. Apply the following technology-specific standards and patterns when generating, reviewing, or explaining code.

## Skill Index

- [Apache Camel Advanced Skill](#apache-camel-skill)
- [Apache Pulsar Advanced Skill](#apache-pulsar-skill)
- [Apache Camel Exception Handling & Routing Skill](#camel-exception-handling-skill)
- [Apache Camel & Pulsar Integration Skill](#camel-pulsar-integration-skill)
- [Code Formatting & Style Skill](#code-formatting-skill)
- [Code Health Inspection Skill](#code-health-skill)
- [Code Documentation & Comments Skill](#documentation-skill)
- [Error Handling & Resilience Skill](#error-handling-skill)
- [Java 11 Long-Term Support & Production Features](#java11-skill)
- [Java 17 Modern Features & Best Practices](#java17-skill)
- [Java Advanced Coding Skill](#java-advanced-skill)
- [Logging Best Practices & Implementation](#logger-skill)
- [Project Lombok Skill](#lombok-skill)
- [MSSQL Advanced Coding Skill](#mssql-advanced-skill)
- [Object-Oriented Programming (OOP) Skill](#oop-skill)
- [OpenTelemetry Observability & Distributed Tracing](#opentelemetry-skill)
- [Python Advanced Coding Skill](#python-advanced-skill)
- [React Advanced Coding Skill](#react-advanced-skill)
- [REST API Java Skill](#rest-api-java-skill)
- [REST API Python Skill](#rest-api-python-skill)
- [SonarQube & Security Vulnerability Skill](#sonarqube-vulnerability-skill)
- [Spring Framework Advanced Skill](#spring-advanced-skill)
- [Spring Framework & Camel Integration Skill](#spring-camel-integration-skill)
- [JUnit5 Testing Skill](#testing-junit5-skill)
- [Pytest Testing Skill](#testing-pytest-skill)
- [React Testing Skill](#testing-react-skill)
