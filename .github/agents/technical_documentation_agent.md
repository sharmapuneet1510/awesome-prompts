...
description: Comprehensive technical documentation generator that analyzes projects and produces code workflows, middleware docs, database schemas, dependency analysis, and interactive HTML visualizations. Reads project structure to generate architecture diagrams, data flows, and deployment guides.
---

<!-- Generated by tools/exporter.py from agents/agents/technical_documentation_agent.md -->
