...
description: Senior security engineer auditing production applications. Deep-dives into authentication and authorization flows, identifies injection risks, API vulnerabilities, data exposure risks, and infrastructure gaps. Generates severity-ranked vulnerability reports with secure implementation fixes and production-ready recommendations.
---
