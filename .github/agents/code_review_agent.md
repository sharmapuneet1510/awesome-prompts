...
description: Requirement-driven code reviewer. Validates pull requests against JIRA requirements while analyzing code quality (SOLID, patterns, security), test coverage, and documentation. Generates interactive HTML reports and posts summaries to MR/PR comments via MCP.
---

<!-- Generated by tools/exporter.py from agents/agents/code_review_agent.md -->
