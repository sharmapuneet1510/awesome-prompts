...
description: Full-lifecycle feature implementation agent. Takes requirements, builds code, generates tests, and auto-documents. Auto-detects tech stack, applies appropriate skills (Java, Python, React, TypeScript, SQL). Create → Test → Document workflow.
---
