...
This file contains advanced technology knowledge used by the coding agents in this repository. Claude should apply these patterns when helping with code in the relevant technology areas.

## Available Skills

| Skill | Applies To |
|-------|------------|
| Apache Camel Advanced Skill | `java, apache-camel, spring-boot, integration...` |
| Apache Pulsar Advanced Skill | `java, python, apache-pulsar, spring-boot...` |
| Apache Camel Exception Handling & Routing Skill | `java, apache-camel, spring-boot, integration...` |
| Apache Camel & Pulsar Integration Skill | `java, apache-camel, apache-pulsar, integration...` |
| Code Formatting & Style Skill | `java, python, javascript, typescript...` |
| Code Health Inspection Skill | `java, python, react, mssql...` |
| Code Documentation & Comments Skill | `java, python, javascript, typescript...` |
| Error Handling & Resilience Skill | `java, python, javascript, react...` |
| Java 11 Long-Term Support & Production Features | `java, java-11, spring-boot, production...` |
| Java 17 Modern Features & Best Practices | `java, java-17, spring-boot, best-practices...` |
| Java Advanced Coding Skill | `java, spring-boot, maven, gradle` |
| Logging Best Practices & Implementation | `java, logging, slf4j, log4j2...` |
| Project Lombok Skill | `java, lombok, spring-boot, maven...` |
| MSSQL Advanced Coding Skill | `mssql, t-sql, sql-server, azure-sql` |
| Object-Oriented Programming (OOP) Skill | `java, python, javascript, oop...` |
| OpenTelemetry Observability & Distributed Tracing | `java, observability, tracing, metrics...` |
| Python Advanced Coding Skill | `python, fastapi, sqlalchemy, pydantic...` |
| React Advanced Coding Skill | `react, typescript, vite, tanstack-query...` |
| REST API Java Skill | `java, spring-boot, rest-api, http...` |
| REST API Python Skill | `python, fastapi, rest-api, http...` |
| SonarQube & Security Vulnerability Skill | `java, python, javascript, security...` |
| Spring Framework Advanced Skill | `java, spring, spring-boot, spring-webflux...` |
| Spring Framework & Camel Integration Skill | `java, apache-camel, spring-boot, spring-framework...` |
| JUnit5 Testing Skill | `java, junit5, testing, mockito...` |
| Pytest Testing Skill | `python, pytest, fastapi, testing...` |
| React Testing Skill | `react, javascript, testing, jest...` |

---

## Apache Camel Advanced Skill

> **Applies to:** java, apache-camel, spring-boot, integration, eip
...
## Apache Camel Exception Handling & Routing Skill

> **Applies to:** java, apache-camel, spring-boot, integration, error-handling
...
## Apache Camel & Pulsar Integration Skill

> **Applies to:** java, apache-camel, apache-pulsar, integration, spring-boot, messaging
...
## Code Formatting & Style Skill

> **Applies to:** java, python, javascript, typescript, code-quality, formatting
...
## Code Health Inspection Skill

> **Applies to:** java, python, react, mssql, all-languages
...
## Code Documentation & Comments Skill

> **Applies to:** java, python, javascript, typescript, documentation, code-quality
...
> **Applies to:** java, python, javascript, react, error-handling, exceptions
...
## Java 11 Long-Term Support & Production Features

> **Applies to:** java, java-11, spring-boot, production, best-practices
...
## Java 17 Modern Features & Best Practices

> **Applies to:** java, java-17, spring-boot, best-practices, patterns
...
## Java Advanced Coding Skill

> **Applies to:** java, spring-boot, maven, gradle
...
> **Applies to:** java, logging, slf4j, log4j2, logback, spring-boot
...
> **Applies to:** java, lombok, spring-boot, maven, gradle, code-generation
...
## MSSQL Advanced Coding Skill

> **Applies to:** mssql, t-sql, sql-server, azure-sql
...
> **Applies to:** java, python, javascript, oop, design-patterns, solid
...
> **Applies to:** java, observability, tracing, metrics, opentelemetry, spring-boot
...
> **Applies to:** python, fastapi, sqlalchemy, pydantic, asyncio
...
## React Advanced Coding Skill

> **Applies to:** react, typescript, vite, tanstack-query, zustand, tailwindcss
...
> **Applies to:** java, spring-boot, rest-api, http, maven
...
## REST API Python Skill

> **Applies to:** python, fastapi, rest-api, http, async
...
## SonarQube & Security Vulnerability Skill

> **Applies to:** java, python, javascript, security, code-quality, sonarqube, owasp
...
## Spring Framework Advanced Skill

> **Applies to:** java, spring, spring-boot, spring-webflux, spring-batch, spring-cloud, spring-security
...
## Spring Framework & Camel Integration Skill

> **Applies to:** java, apache-camel, spring-boot, spring-framework, integration
...
## JUnit5 Testing Skill

> **Applies to:** java, junit5, testing, mockito, testcontainers, spring-boot
...
> **Applies to:** python, pytest, fastapi, testing, async, mocking
...
> **Applies to:** react, javascript, testing, jest, react-testing-library, typescript
