...
- Read [FRAMEWORK_GUIDE.md](../00-getting-started/concepts.md) for detailed documentation
- Check [API_REFERENCE.md](../02-reference/functions.md) for class documentation
- See [MIGRATION.md](../../CHANGELOG.md) for migrating legacy formats
