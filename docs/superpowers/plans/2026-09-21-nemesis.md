...
| 15 existing documents | registration and counts | 5 |
...
EDITS_DOCS = [
    ...
    ("skills/README.md",
     "| 36 | [MCP Server Builder](mcp_server_builder_skill.md) |",
...
- Modify: `README.md`, `CLAUDE.md`, `CHANGELOG.md`, `agents/README.md`, `docs/README.md`, `docs/01-workflows/README.md`, `docs/01-workflows/sdlc-playbook.md`, `docs/01-workflows/14-export-to-platforms.md`, `docs/02-reference/functions.md`, `docs/02-reference/README.md`, `docs/02-reference/agents.md`, `docs/02-reference/skills.md`, `docs/03-guides/exporting-to-platforms.md`, `docs/04-examples/README.md`, `skills/README.md`
...
Expected: **PASS** — `nemesis_register docs: 52 edits in 15 files`
...
```bash
git add docs/01-workflows/15-challenge-a-conclusion.md README.md CLAUDE.md CHANGELOG.md agents/README.md docs/README.md docs/01-workflows/README.md docs/01-workflows/sdlc-playbook.md docs/01-workflows/14-export-to-platforms.md docs/02-reference/functions.md docs/02-reference/README.md docs/02-reference/agents.md docs/02-reference/skills.md docs/03-guides/exporting-to-platforms.md docs/04-examples/README.md skills/README.md tests/nemesis/test_nemesis_registration.py
...
Expected: **PASS** — `326 passed` with the same `4 failed` and `41 errors` as the baseline: 233 + 93 = 326, and **no new failure**.
