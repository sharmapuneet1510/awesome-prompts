> **ARCHIVED 2026-08-21 — not current.**
> Superseded by [docs/02-reference/functions.md](../../02-reference/functions.md). This file documents 31 functions; there are now 42.
> Counts and structure in this file are out of date. See [../README.md](../README.md).
